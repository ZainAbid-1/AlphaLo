  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A2B48] via-[#2a3f5f] to-[#1A2B48]">
      <Container fluid className="p-0 overflow-hidden">
        <Row className="g-0 min-h-[calc(100vh-64px)]">
          {/* ─── LEFT SIDEBAR: Progress ─── */}
          <Col lg={4} xl={3} className="hidden lg:flex flex-col justify-between p-8 border-r border-white/10">
            <div>
          ...
          {/* ─── RIGHT: Content ─── */}
          <Col lg={8} xl={9} className="p-6 sm:p-8 lg:p-12 overflow-y-auto">
            {/* Mobile progress bar */}
