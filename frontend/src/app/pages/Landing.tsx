...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A2B48] via-[#2a3f5f] to-[#1A2B48] relative overflow-hidden flex items-center justify-center">
            ...
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-300">
                  Sign in to access your personalized exam prep
                </p>
              </div>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full bg-white text-gray-900 py-4 rounded-xl font-bold hover:bg-gray-100 transition-all flex items-center justify-center gap-3 group shadow-lg"
                >
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-400 text-sm">
                  By continuing, you agree to AlphaLo's Terms of Service and Privacy Policy.
                </p>
              </div>
            </div>
          </Col>
