  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A2B48] via-[#2a3f5f] to-[#1A2B48]">
      <Container className="py-12">
        <Row className="mb-12">
          <Col md={12} className="border-l-2 border-[#7C3AED] pl-6">
        ...
        <Row className="g-4">
          ...
          <Col xs={12}>
            <div className="backdrop-blur-xl bg-gradient-to-r from-[#10B981]/10 to-[#3B82F6]/10 border border-white/10 rounded-2xl p-6">
